...
### `git clone https://github.com/anton-shelepov/news-filtration-test.git`

После чего, в выбранной вами директории, сформируется папка с проектом (*news-filtration-test*)
